        ...
        <div className="flex justify-center px-4 py-16 dark:bg-[#111827] bg-[#EBEBEB]">
          <div className="flex flex-col">
            <div className="flex md:flex-row flex-col justify-center items-center md:space-x-6 space-x-0 space-y-6 lg:px-10 px-4 md:py-14 py-6">
              ...
              <div>
                <div className="mockup-code dark:bg-[#191D24] bg-white">
                  ...
                  <pre data-prefix=">" className="text-success">
                    <code>✓ Javascripts , Typescripts , C#</code>
                  </pre>
                  <pre data-prefix=">" className="text-warning">
                    <code>⭐️ Tools:</code>
                  </pre>
            ...
            <div className="flex flex-col mx-[100px] text-center dark:text-[#A6ADBA] text-black">
              <h1>
                I work as a{" "}
                <span className=" text-[#36D399]">Software Programmer</span> and{" "}
                <span className=" text-[#36D399]">Filter Effect Creater</span>{" "}
                and I am interested in learning about Frontend Developer, Mobile
                Appication from React Native and Android Studio.
              </h1>
              <h1>
                I've previously worked on game development, Filter Creater from
                Instagram and Tiktok, Virtual tour on website and Augmented
                reality on website.
              </h1>
            </div>
            </div>
